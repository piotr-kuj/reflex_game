...
namespace KIK.Services
{
    ...
    {
        private static readonly char[] _cookie = new[] { '|' };
        ...
        public override async Task<ProviderCultureResult> DetermineProviderCultureResult(HttpContext httpContext)
        {
            ...
            else if (GetCultureFromQueryString(httpContext, out culture))
                return new ProviderCultureResult(culture, culture);
            else if (GetCultureFromQueryString(httpContext, out culture))
                return new ProviderCultureResult(culture, culture);
        ...
        public static string ParseCookieValue(string value)
        {
            ...
            var parts = value.Split(_cookie, StringSplitOptions.RemoveEmptyEntries);
            if (parts.Length != 2)
            {
                return null;
            }
